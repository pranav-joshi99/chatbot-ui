...
AS $$
DECLARE
  project_url TEXT := 'https://wlkfeaqvfzvsezsbtqsx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indsa2ZlYXF2Znp2c2V6c2J0cXN4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1MDQ5MDA2OSwiZXhwIjoyMDY2MDY2MDY5fQ.w6LYnIL7k5sJTqAD74W6O4_I5BwQDSzmyQpadPfRZe8'; -- full access needed for http request to storage
